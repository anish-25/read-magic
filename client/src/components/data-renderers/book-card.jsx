    ...
    return (
        <Card
            ...
            <div className="space-y-2 whitespace-nowrap flex flex-col justify-start items-start">
                ...
                <Typography onClick={() => { navigate(`/book-details/${book?._id}`) }} className={'text-black text-left text-base font-bold leading-normal cursor-pointer whitespace-pre-wrap min-h-[80px] max-h-[80px]'}>
